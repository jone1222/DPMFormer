_base_ = [
    ...
    '../../_base_/datasets/city2corruption/city2elastic_transform-512.py']
...
model = dict(
    type='metanet_contra_aug_tqdm_CLIP',
    ...
    decode_head=dict(
        ...
        loss_dice=dict(
            ...
            eps=1.0,
            loss_weight=5.0),
        loss_cls_consistency=dict(
            type='ClassConsistencyLoss',
            use_sigmoid=False,
            loss_weight=10.0,
            reduction='mean',
            class_weight=[1.0] * 19 + [0.1]),
        loss_mask_consistency=dict(
            type='MaskConsistencyLoss',
            use_sigmoid=True,
            reduction='mean',
            loss_weight=10.0),
        loss_pred_consistency=dict(
            type='PredConsistencyLoss',
            use_sigmoid=True,
            reduction='mean',
            loss_weight=0.0),
        train_cfg=dict(
