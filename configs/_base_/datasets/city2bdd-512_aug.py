...
train_pipeline = [
    ...
    dict(type='AugStrongPhotoMetricDistortion'),
    dict(type='AugNormalize', **img_norm_cfg),
    dict(type='AugPad', size=crop_size, pad_val=0, seg_pad_val=255),
    dict(type='ToMask'),
    dict(type='DefaultFormatBundle'),
    dict(type='Collect', keys=['img', 'gt_semantic_seg', 'gt_masks', 'gt_labels', 'img_org'])]
...
src_dataset_dict = dict(
    ...
    data_root='/scratch/jone9312/DG_SemSeg/cityscapes',
...
tgt_dataset_dict = dict(
    type='BDD100kDataset',
    data_root='/scratch/jone9312/DG_SemSeg/bdd',
